...
class AnswerEval(BaseModel):
    ...
    legal_source_accuracy: float = Field(
        description="How accurately does the answer identify the correct EU AI Act Article, Recital, or Annex as the main legal source? 1 (wrong legal source) to 5 (correct main legal source). A substantively correct answer that relies primarily on a different legal provision from the reference answer should not receive 5."
    )
    ...
    judge_messages = [
        {
            ...
            "content": (
                ...
                "about Regulation (EU) 2024/1689, the EU AI Act. "
