...
(f)	 the licence.
2.	
A detailed description of the elements of the model referred to in point 
...
model is designed to optimise for and the relevance of the different 
...
of limitations.
2.	
Where applicable, a detailed description of the measures put in place 
