...
Procedure
1.	
Where a general-purpose AI model meets the condition referred to in 
...
the information necessary to demonstrate that the relevant requirement has 
...
2.	
The provider of a general-purpose AI model that meets the condition 
...
4.	
The Commission may designate a general-purpose AI model as 
...
5.	
Upon a reasoned request of a provider whose model has been 
...
6.	
The Commission shall ensure that a list of general-purpose AI models with 
