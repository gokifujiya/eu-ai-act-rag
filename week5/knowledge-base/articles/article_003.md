...
(4)	
‘deployer’ means a natural or legal person, public authority, agency or 
...
(5)	
‘authorised representative’ means a natural or legal person located or 
...
(6)	
‘importer’ means a natural or legal person located or established in the 
...
(7)	
‘distributor’ means a natural or legal person in the supply chain, other 
than the provider or the importer, that makes an AI system available on 
the Union market;

(8)	
‘operator’ means a provider, product manufacturer, deployer, 
authorised representative, importer or distributor;
(9)	
‘placing on the market’ means the first making available of an AI system 
...
(38)	 ‘sensitive operational data’ means operational data related to activities 
...
(53)	 ‘real-world testing plan’ means a document that describes the 
...
(61)	 ‘widespread infringement’ means any act or omission contrary to Union 
...
(66)	 ‘general-purpose AI system’ means an AI system which is based on a 
