...
risk
1.	
AI systems presenting a risk shall be understood as a ‘product 
...
2.	
Where the market surveillance authority of a Member State has 
...
national public authority referred to in Article 77(1), finds that the AI system 
...
3.	
Where the market surveillance authority considers that the non-
...
take.
4.	
The operator shall ensure that all appropriate corrective action is taken 
in respect of all the AI systems concerned that it has made available on the 
Union market.
5.	
Where the operator of an AI system does not take adequate corrective 
...
(b)	 a failure of a high-risk AI system to meet requirements set out in 
