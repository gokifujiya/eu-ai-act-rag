...
provide the reasonably expected technical access and other assistance that 
...
3.	
In the case of high-risk AI systems that are safety components of 
...
4.	
The provider of a high-risk AI system and the third party that supplies 
...
5.	
Paragraphs 2 and 3 are without prejudice to the need to observe and 
