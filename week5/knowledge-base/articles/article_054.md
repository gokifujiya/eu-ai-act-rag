...
models
1.	
Prior to placing a general-purpose AI model on the Union market, 
...
2.	
The provider shall enable its authorised representative to perform the 
tasks specified in the mandate received from the provider.

3.	
The authorised representative shall perform the tasks specified in the 
...
4.	
The mandate shall empower the authorised representative to be 
...
therefor.
6.	
The obligation set out in this Article shall not apply to providers of 
