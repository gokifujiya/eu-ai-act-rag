...
1.	
The Commission may request the provider of the general-purpose AI 
...
Regulation.
2.	
Before sending the request for information, the AI Office may initiate 
a structured dialogue with the provider of the general-purpose AI model.
3.	
Upon a duly substantiated request from the scientific panel, the 
...
Article 68(2).
4.	
The request for information shall state the legal basis and the purpose 
...
5.	
The provider of the general-purpose AI model concerned, or its 
